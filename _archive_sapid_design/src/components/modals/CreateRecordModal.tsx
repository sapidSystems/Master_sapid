...
export const CreateRecordModal: React.FC<CreateRecordModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="w-[95%] sm:w-full max-w-2xl max-h-[90vh] flex flex-col bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in zoom-in-95 duration-150"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
          {errorMessage && (
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800/60 flex items-center gap-2 text-xs sm:text-sm text-rose-700 dark:text-rose-300">
          ...
          {module === 'daily-leather' || module === 'material' || module === 'packaging' ? (
            <div className="space-y-3 p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div>
                  <label htmlFor="create-wono" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                  ...
                  <input
                    ...
                    className="w-full min-h-[42px] px-3 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-brand-500 focus:outline-none"
                  />
                </div>

                <div>
                  <label htmlFor="create-buyer" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="create-wodate" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="create-indentdate" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="create-shipdate" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <div>
                <label htmlFor="create-date" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <input
                  ...
                  value={date}
                  onChange={(e) => setDate(e.target.value)}
                  className="w-full min-h-[44px] px-3.5 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-brand-500 focus:outline-none text-sm transition-all"
                />
              </div>

              <div>
                <label htmlFor="create-buyer" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  Buyer Code <span className="text-rose-500">*</span>
                </label>
                <input
                  id="create-buyer"
          ...
          {module === 'new-leather' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-2">
              <div>
                <label htmlFor="nl-name" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <input
                  ...
                  className="w-full min-h-[44px] px-3.5 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-brand-500 focus:outline-none text-sm"
                />
              </div>

              <div>
                <label htmlFor="nl-color" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div>
                <label htmlFor="nl-qty" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div>
                <label htmlFor="nl-tannery" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
            ...
            <div className="pt-2 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-brand-600 dark:text-brand-400 bg-brand-50 dark:bg-brand-950/50 hover:bg-brand-100 dark:hover:bg-brand-900/50 transition-colors"
                >
              ...
              <div className="space-y-3">
                {leatherItems.map((sub, idx) => (
                  <div
                    key={sub.id}
                    className="p-3.5 sm:p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40 relative space-y-3"
                  >
                    <div className="flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full min-h-[42px] px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-xs sm:text-sm focus:ring-2 focus:ring-brand-500 focus:outline-none"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full min-h-[40px] px-3 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-xs focus:ring-2 focus:ring-brand-500 focus:outline-none"
                      />
                    </div>
                  </div>
                ))}
          ...
          {module === 'material' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-2">
              <div>
                <label htmlFor="mat-name" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <input
                  ...
                  className="w-full min-h-[44px] px-3.5 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-brand-500 focus:outline-none"
                />
              </div>

              <div>
                <label htmlFor="mat-spec" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  Specification
                </label>
                <input
                  id="mat-spec"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label htmlFor="mat-qty" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="mat-unit" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                    Unit
                  </label>
                  <select
                    id="mat-unit"
              ...
              <div>
                <label htmlFor="mat-supplier" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
          ...
          {module === 'packaging' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-2">
              <div>
                <label htmlFor="pkg-type" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div>
                <label htmlFor="pkg-spec" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  Specification
                </label>
                <input
                  id="pkg-spec"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label htmlFor="pkg-qty" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                    Quantity <span className="text-rose-500">*</span>
                  </label>
                  <input
                    id="pkg-qty"
                ...
                <div>
                  <label htmlFor="pkg-unit" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                    Unit
                  </label>
                  <select
                    id="pkg-unit"
              ...
              <div>
                <label htmlFor="pkg-supplier" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  Supplier / Vendor <span className="text-rose-500">*</span>
                </label>
                <input
                  id="pkg-supplier"
          ...
          {module !== 'daily-leather' && (
            <>
              <div className="pt-2">
                <label htmlFor="create-target-date" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div>
                <label htmlFor="create-remarks" className="block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-brand-500 focus:outline-none resize-none"
                />
              </div>
            </>
          )}
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col-reverse sm:flex-row items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={onClose}
              disabled={isSubmitting}
              className="w-full sm:w-auto min-h-[44px] px-5 py-2.5 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              Cancel
            </button>
            <button
