  ...
  return (
    <div className="space-y-4 sm:space-y-5 animate-in fade-in duration-200">
      ...
      {(module === 'material' || module === 'packaging') && (
        <div className="bg-white dark:bg-slate-900 p-2 sm:p-2.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-soft flex items-center gap-2">
          <button
            type="button"
            onClick={() => {
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-2">
        <button
          ...
          className={`min-h-[40px] px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all flex items-center gap-2 ${
            activeTab === 'pending'
              ? 'bg-slate-900 text-white dark:bg-white dark:text-slate-900 shadow-soft-sm'
              : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'
          }`}
        >
