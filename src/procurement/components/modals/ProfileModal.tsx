        ...
        <div className="p-6 space-y-4">
          ...
          <div className="pt-2 flex flex-col gap-2">
            <button
              ...
              className="w-full min-h-[44px] px-4 py-2.5 rounded-xl text-xs font-semibold text-rose-600 bg-rose-50 hover:bg-rose-100 transition-colors flex items-center justify-center gap-2"
            >
